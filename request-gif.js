...
function fetchAndDisplayGif(event) {
    ...
    {
      $("#feedback").text("You should be ashamed of yourself! You aren't a REAL Jackson 5 fan! You don't deserve a gif!");
    ...
    var params = {
        ...
        tag : "jackson 5 + tag" // TODO should be e.g. "jackson 5 dance"
    };
